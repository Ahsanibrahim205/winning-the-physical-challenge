...
function _renderCallback () { // DO NOT USE ARROW FUNCTION
  ...
  var templateData = this.$data; // or app.Navbar.$data

  console.log('Component Navbar has been rendered with Data:', templateData);
...
/* export local variables or functions as properties accessible through component:Navbar as app.Navbar.actionX(); */
var props = {
