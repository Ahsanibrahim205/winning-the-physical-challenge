...
function _renderCallback () { // DO NOT USE ARROW FUNCTION
  ...
  var templateData = this.$data; // or app.S8.$data

  console.log('Component S8 has been rendered with Data:', templateData);
...
/* export local variables or functions as properties accessible through component:S8 as app.S8.actionX(); */
var props = {
