...
function _renderCallback () { // DO NOT USE ARROW FUNCTION
  ...
  var templateData = this.$data; // or app.Slide.$data

  console.log('Component Slide has been rendered with Data:', templateData);
...
/* export local variables or functions as properties accessible through component:Slide as app.Slide.actionX(); */
var props = {
