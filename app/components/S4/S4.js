...
function _renderCallback () { // DO NOT USE ARROW FUNCTION
  ...
  var templateData = this.$data; // or app.S4.$data

  console.log('Component S4 has been rendered with Data:', templateData);
...
/* export local variables or functions as properties accessible through component:S4 as app.S4.actionX(); */
var props = {
